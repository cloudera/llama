...
#    apt-get -y remove openjdk* maven2 || /bin/true
    ...
    debuild --preserve-envvar PATH --preserve-envvar JAVA_HOME --preserve-envvar JAVA5_HOME --preserve-envvar MAVEN3_HOME --preserve-envvar THRIFT_HOME --preserve-envvar FORREST_HOME --preserve-envvar IVY_MIRROR_PROP --preserve-envvar NODE_HOME --preserve-envvar SCALA_HOME --preserve-envvar REAL_BUILD_NUMBER -uc -us $DEBUILD_FLAG
