...
sudo -E -u www-data GNUPGHOME=$BASE_DIR/apt/gpg-home/ $GPG_AGENT_CRAP $BASE_DIR/apt/update_repo.sh -s ${S3_BUCKET} -b $BUILD_ID -c cdh3 -r /var/www/archive_public/debian -d $BASE_DIR
