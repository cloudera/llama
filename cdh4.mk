...
PIG_BASE_REF=cdh4-base-$(PIG_BASE_VERSION)_1
PIG_BUILD_REF=cdh4-$(PIG_BASE_VERSION)_1
...
OOZIE_BASE_VERSION=3.2.0
OOZIE_RELEASE_VERSION=1
OOZIE_TARBALL_DST=oozie-$(OOZIE_BASE_VERSION).tar.gz
OOZIE_TARBALL_SRC=oozie-$(OOZIE_BASE_VERSION)-incubating.tar.gz
...
SOLR_TARBALL_DST=solr-$(SOLR_BASE_VERSION).tar.gz
