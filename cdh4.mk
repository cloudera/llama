...
# Access
ACCESS_NAME=access
ACCESS_RELNOTES_NAME=Cloudera authorization component
ACCESS_PKG_NAME=hive-access
ACCESS_BASE_VERSION=1.0.0
ACCESS_RELEASE_VERSION=1
ACCESS_PKG_VERSION=$(ACCESS_BASE_VERSION)
ACCESS_TARBALL_DST=access-$(ACCESS_BASE_VERSION).tar.gz
ACCESS_TARBALL_SRC=$(ACCESS_TARBALL_DST)
ACCESS_GIT_REPO=$(REPO_DIR)/cdh4/access
