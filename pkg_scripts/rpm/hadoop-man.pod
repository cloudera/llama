...
This symbolic link points to the currently active Hadoop configuration directory.  This link
is managed by the alternatives(8) command.  Hadoop system administrators can deploy
new Hadoop configurations manually or by installing a Hadoop configuration RPM.

To manually manage alternative configurations...
