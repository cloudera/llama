...
* :supportedHadoopPackage calls:
** +stitch-ext/cloudera.py:SetupBuildStep+
*** calls +//tools/setup-package-build+
**** Unpacks the pristine source into the assembly directory
**** Calls +//tools/create-cloudera-dir+
...
***** Calls +//tools/generate-build-properties+
...
The src rpm/deb targets are repos/hadoop-package/:deb and
repos/hadoop-package/:rpm

This section to be filled out more soon.
