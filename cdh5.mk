...
PREV_RELEASE_TAG=cdh5.0.0b1-release
...
PARQUET_FORMAT_BUILD_REF=cdh5-$(PARQUET_FORMAT_BASE_VERSION)
...
SPARK_BASE_VERSION=0.8.0
SPARK_PKG_VERSION=$(SPARK_BASE_VERSION)
SPARK_RELEASE_VERSION=1
SPARK_TARBALL_SRC=spark-$(SPARK_BASE_VERSION).tar.gz
SPARK_TARBALL_DST=$(SPARK_TARBALL_SRC)
SPARK_GIT_REPO=$(REPO_DIR)/cdh5/spark
SPARK_BASE_REF=cdh5-base-$(SPARK_BASE_VERSION)
SPARK_BUILD_REF=cdh5-$(SPARK_BASE_VERSION)
...
CRUNCH_BASE_VERSION=0.8.0
CRUNCH_RELEASE_VERSION=0
...
CRUNCH_BUILD_REF=cdh5-$(CRUNCH_BASE_VERSION)
