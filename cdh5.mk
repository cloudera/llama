...
SENTRY_BASE_VERSION=1.1.0
SENTRY_RELEASE_VERSION=1
SENTRY_PKG_VERSION=$(SENTRY_BASE_VERSION)
SENTRY_TARBALL_DST=sentry-$(SENTRY_BASE_VERSION).tar.gz
SENTRY_TARBALL_SRC=sentry-1.1.0-src.tar.gz
SENTRY_GIT_REPO=$(REPO_DIR)/cdh5/sentry
SENTRY_BASE_REF=cdh5-base-1.1.0
