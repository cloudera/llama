...
PREV_RELEASE_TAG=cdh5.1.0-release
...
BIGTOP_TOMCAT_BASE_VERSION=6.0.41
...
HADOOP_BASE_VERSION=2.5.0
HADOOP_RELEASE_VERSION=1
HADOOP_TARBALL_DST=hadoop-2.5.0-src.tar.gz
...
PARQUET_BASE_REF=cdh5-base-1.5.0
...
PARQUET_FORMAT_BASE_VERSION=2.1.0
...
PARQUET_FORMAT_BASE_REF=cdh5-base-2.1.0
...
# Impala JDBC
IMPALA_JDBC_NAME=impala-jdbc
IMPALA_JDBC_RELNOTES_NAME=Impala-compatible JDBC driver based on Hive 0.12.0
IMPALA_JDBC_PKG_NAME=impala-jdbc
IMPALA_JDBC_BASE_VERSION=$(IMPALA_BASE_VERSION)
IMPALA_JDBC_PKG_VERSION=$(IMPALA_JDBC_BASE_VERSION)+$(CDH_REL_STRING)+0
IMPALA_JDBC_RELEASE_VERSION=1
IMPALA_JDBC_TARBALL_DST=impala-jdbc-0.12.0.tar.gz
IMPALA_JDBC_TARBALL_SRC=hive-0.12.0.tar.gz
IMPALA_JDBC_GIT_REPO=$(REPO_DIR)/cdh5/impala-jdbc
IMPALA_JDBC_BASE_REF=cdh5-base-0.12.0
IMPALA_JDBC_BUILD_REF=HEAD
IMPALA_JDBC_PACKAGE_GIT_REPO=$(REPO_DIR)/cdh5/cdh-package/bigtop-packages/src
IMPALA_JDBC_SITE=$(CLOUDERA_ARCHIVE)
IMPALA_JDBC_SRC_PREFIX=src/
$(eval $(call PACKAGE,impala-jdbc,IMPALA_JDBC))
...
HADOOP_LZO_PKG_VERSION=$(HADOOP_LZO_BASE_VERSION)+$(CDH_REL_STRING)+0
...
IMPALA_LZO_BASE_VERSION=$(IMPALA_BASE_VERSION)
