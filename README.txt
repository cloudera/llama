...
Llama provides a Thrift API for Impala to request/release and use allocations 
outside of Yarn-managed container processes.

For details on how to build or run Llama please refer to Llama documentation.